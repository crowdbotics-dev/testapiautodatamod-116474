...
## Project Structure
    ...
    ├── testapiautodatamod_116474  # Django project configurations
...
1. Clone this repo and `cd testapiautodatamod_116474`
...
2. Clone this repo and `cd testapiautodatamod_116474`
